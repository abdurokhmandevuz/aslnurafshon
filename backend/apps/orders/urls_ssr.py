...
urlpatterns = [
    ...
    path('cart/apply-promo/', views_ssr.apply_promo_view, name='apply_promo'),
    ...
    path('orders/<int:order_id>/repeat/', views_ssr.repeat_order_view, name='repeat_order'),
    path('corporate/', views_ssr.corporate_inquiry_view, name='corporate_inquiry'),
]
